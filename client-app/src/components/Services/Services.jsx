...
const Service = () => {
    return (
        <div id="service">
            <h5 className="text-center"><b>Service</b></h5>
                ...
                <Row className="justify-content-center">
                    <Card className="col-md-4" style={{ width: '23rem' }}>
                        ...
                        <Card.Body className="text-center">
                            <Card.Title> <b>Wide Range of Properties</b> </Card.Title>
                            <Card.Text>
                    ...
                    <Card className="col-md-4" style={{ width: '23rem' }}>
                        ...
                        <Card.Body className="text-center">
                            <Card.Title> <b>Financing Made Easy</b> </Card.Title>
                            <Card.Text>
                    ...
                    <Card className="col-md-4" style={{ width: '23rem' }}>
                        ...
                        <Card.Body className="text-center">
                            <Card.Title> <b>Trusted by Thousands</b></Card.Title>
                            <Card.Text>
