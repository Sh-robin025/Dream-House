            ...
            <Container>
                <Row className="pb-5">
                    <Col md={8}>
                        ...
                        <h6>{size} sq-ft., 3 Bedroom, Semi-furnished, Luxurious, South facing apartment for rent in {location}</h6>
                        <h4 className="mt-4"><b>Price Details:-</b></h4>
                        ...
                        <h6>Floor: {floor}</h6>
                        <h6>Room Category: 3 large bedroom with 3 barandas spacious drawing,dinning and family living room.High decorated kitchen with store room. </h6>
                        <h6>Facilities: 1 modern lift,All modern amenities and semi furnished.</h6>
                    ...
                    <Col md={4}>
                        <form className="bg-light p-3" onSubmit={handleSubmit}>
                            <h3 className="text-center"><b>Checkout</b></h3>
